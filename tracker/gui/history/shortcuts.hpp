...
enum class ShortcutAction {
    ...
    FileExit,
    SongPlayPause,
    SongPlayFromCurrentPage,
    SongPlayFromCurrentPosition,
    SongStop,
    EditUndo,
    EditRedo,
    EditDelete,
...
class ShortcutManager {
  ...
  private:
    ...
    const std::unordered_map<ShortcutAction, Shortcut> shortcuts = {
        ...
        {ShortcutAction::SongPlayFromCurrentPage, {true, false, false, ImGuiKey_Space}},
        {ShortcutAction::SongPlayFromCurrentPosition, {true, true, false, ImGuiKey_Space}},
