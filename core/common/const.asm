...
; Commands
    ...
    %define COMMAND_SET_MASTER_GAINER 3
    %define COMMAND_SET_BPM 4
    %define COMMAND_SET_DIVISION 5
    %define COMMAND_CHANGE_BYTE_VALUE 6
    %define COMMAND_CHANGE_WORD_VALUE 7
    %define COMMAND_CHANGE_DWORD_VALUE 8
    %define COMMAND_CHANGE_FLOAT_VALUE 9
